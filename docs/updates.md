...
The 0.1.6 release supports direct Community updates from 0.1.3. It adds encrypted durable resume
for the owner-only, purchase-bound in-place Pro upgrade and pins database migration and isolated
candidate verification to the exact signed Pro release uploaded to Cloudflare. Older installations
must first reach 0.1.3; no direct update from an older artifact is claimed.
