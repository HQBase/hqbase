...
The 0.1.7 release supports direct Community updates from 0.1.3. It adds encrypted durable resume,
pins migration to the exact signed Pro candidate, and temporarily enables then restores Cloudflare
Preview URLs for isolated validation when needed. Older installations must first reach 0.1.3; no
direct update from an older artifact is claimed.
