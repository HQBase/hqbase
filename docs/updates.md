...
The 0.1.3 release supports direct Community updates from 0.1.2. Older installations must first
reach 0.1.2; no direct update from an older artifact is claimed.
